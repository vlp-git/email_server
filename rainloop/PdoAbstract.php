...
abstract class PdoAbstract
{
	...
	protected function getPDO()
	{
		...
		$sType = $sDsn = $sDbLogin = $sDbPassword = $sDbOptions = '';
		...
		$sDbOptions = array(
			\PDO::MYSQL_ATTR_SSL_KEY => '/etc/ssl/sql_client/client-key.pem',
			\PDO::MYSQL_ATTR_SSL_CERT => '/etc/ssl/sql_client/client-cert.pem',
			\PDO::MYSQL_ATTR_SSL_CA => '/etc/ssl/sql_client/ca-cert.pem',
			\PDO::MYSQL_ATTR_SSL_CAPATH => '/etc/ssl/sql_client/',
		);
